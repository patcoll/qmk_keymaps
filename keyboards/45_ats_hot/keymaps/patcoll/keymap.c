...
[_QWERTY] = LAYOUT_wrapper(
  ...
  KC_LSFT, _________________QWERTY_L3_________________, _________________QWERTY_R3_________________, KC_UP,            _______,
  KC_LCTL, KC_LGUI, KC_LALT, SFT_SPC,                   RSE_ENT, RSE_ENT, KC_LCTL, __QWERTY_R4_ARROW_KEYS__
),
