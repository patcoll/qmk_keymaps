...
[_GAMING] = LAYOUT_wrapper(
  _______, _________________GAMING_L1_________________, _________________GAMING_R1_________________, KC_BSPC, KC_BSPC,
  _______, _________________GAMING_L2_________________, _________________GAMING_R2_________________, KC_QUOT,
  _______, _________________GAMING_L3_________________, _________________GAMING_R3_________________, KC_LSFT,
  _______, _______, _______, KC_SPC,  KC_SPC,                    KC_SPC,   _______, _______, _______
),
...
[_MOUSE] = LAYOUT_wrapper(
  ...
  _______, _______, KC_BTN1, KC_BTN1, KC_BTN1,                   KC_BTN1, KC_BTN2, _______, _______
),
};
