...
[_LOWER] = LAYOUT_grid(
  ...
  QK_BOOT,   _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_LCTL, KC_LCTL, _______, _______, KC_HOME, KC_PGDN, KC_END
),
...
[_RAISE] = LAYOUT_grid(
  ...
  QK_BOOT,   _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_LCTL, KC_LCTL, _______, _______, _______, KC_BRID, _______
),
