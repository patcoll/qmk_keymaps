...
[_QWERTY] = LAYOUT_wrapper(
  ...
  _________________QWERTY_L3_________________, KC_N,    KC_M,    KC_COMM, KC_UP,  SFT_SLSH,
  KC_LCTL, KC_LGUI, KC_LALT, SFT_SPC, RSE_ENT, KC_LEFT, KC_DOWN, KC_RGHT
),
...
[_GAMING] = LAYOUT_wrapper(
  ...
  _________________GAMING_L3_________________, KC_N,    KC_M,    KC_COMM, KC_UP,  SFT_SLSH,
  _______, _______, _______, KC_SPC,  KC_ENT,  KC_LEFT, KC_DOWN, KC_RGHT
),
