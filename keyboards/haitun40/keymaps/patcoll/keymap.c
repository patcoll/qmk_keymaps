...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  { \
       { KC_TAB,   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,   KC_P,      KC_LBRC,   QK_BOOT}, \
       {KC_CAPS,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,   KC_SCLN,   KC_QUOT,   KC_ENT}, \
       {KC_LSFT,  KC_BSLS,   KC_Z, KC_X,     KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM,   KC_DOT,   KC_SLSH,   KC_RSFT}, \
       {KC_NO,  KC_LGUI, KC_LALT,   KC_NO,   KC_NO,   KC_NO,   KC_SPC,   KC_NO,   KC_NO,   KC_NO,   MO(1),   QK_BOOT,   KC_NO} \
 },
  { \
       { BAU_TOG,  BLE_DEL,   BLE_RESET,   KC_NO,     KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   RESET}, \
       { QK_BOOT,    BL_SW_1,   BL_SW_2,     BL_SW_3,   RADIO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO}, \
       { KC_NO,   KC_NO,     KC_NO,       KC_NO,     KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   VIAL_RESET}, \
