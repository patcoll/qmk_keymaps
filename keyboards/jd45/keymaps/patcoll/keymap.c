...
[_QWERTY] = LAYOUT_wrapper(
  ...
  _______, KC_HYPR, KC_LGUI, KC_LALT, SFT_SPC,                   RSE_ENT, KC_LCTL, __QWERTY_R4_NORMAL_KEYS_
),
...
[_OSK] = LAYOUT_wrapper(
  ...
  _______, _______, _______, _______, ALT_TAB,                   ALT_TAB,  _______, __OSK_R4_ARROW_KEYS___
),
