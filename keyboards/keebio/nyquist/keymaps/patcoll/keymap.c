...
[_LOWER] = LAYOUT(
  ...
  QK_BOOT,   _______, _______, _______, _______, _______, KC_LCTL, _______, _______, KC_HOME, KC_PGDN, KC_END
),
...
[_RAISE] = LAYOUT(
  ...
  QK_BOOT,   _______, _______, _______, _______, _______, KC_LCTL, _______, _______, _______, KC_BRID, _______
),
