...
[_QWERTY] = LAYOUT_wrapper(
  _________________QWERTY_L1_________________, KC_NO, _________________QWERTY_R1_________________,
  _________________QWERTY_L2_________________,        _________QWERTY_R2_FOUR________, TO(_RAISE),
  _________________QWERTY_L3_________________,        _________________QWERTY_R3_________________,
  KC_LCTL, SFT_SPC, RSE_ENT, KC_LALT
),

[_NAV] = LAYOUT_wrapper(
  __________________NAV_L1___________________, KC_NO, __________________NAV_R1___________________,
  ...
  RESET,   MO_LWR, MO_RSE, _______
),

[_LOWER] = LAYOUT_wrapper(
  _________________LOWER_L1__________________, KC_NO, _________________LOWER_R1__________________,
...
[_RAISE] = LAYOUT_wrapper(
  _________________RAISE_L1__________________, KC_NO, _________________RAISE_R1__________________,
...
[_MEDIA] = LAYOUT_wrapper(
  _________________MEDIA_L1__________________, KC_NO, _________________MEDIA_R1__________________,
...
[_MOUSE] = LAYOUT_wrapper(
  _________________MOUSE_L1__________________, KC_NO, _________________MOUSE_R1__________________,
