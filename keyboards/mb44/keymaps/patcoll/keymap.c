...
[_QWERTY] = LAYOUT_wrapper(
  ...
  CTL_ESC, _________________QWERTY_L2_________________, _________________QWERTY_R2_________________, MO_RSE,
  KC_LSFT, _________________QWERTY_L3_________________, _________________QWERTY_R3_ARROWS__________, SFT_SLSH,
  KC_LCTL, KC_LGUI, KC_LALT, SFT_SPC,                   __QWERTY_R4_ARROW_KEYS__
),
...
[_NAV] = LAYOUT_wrapper(
  ...
  _______, _______, _______, ALT_TAB,                   __NAV_R4_ARROW_KEYS___
),
...
[_OSK] = LAYOUT_wrapper(
  ...
  _______, _______, _______, _______,                   __OSK_R4_ARROW_KEYS___
),
...
[_LOWER] = LAYOUT_wrapper(
  ...
  _______, _______, _______, _______,                   __LOWER_R4_ARROW_KEYS__
),
...
[_RAISE] = LAYOUT_wrapper(
  ...
  _______, _______, _______, _______,                   __RAISE_R3_ARROW_KEYS__
),
...
[_MEDIA] = LAYOUT_wrapper(
  ...
  _______, _______, _______, _______,                   __MEDIA_R3_ARROW_KEYS__
),
...
[_MOUSE] = LAYOUT_wrapper(
  ...
  _______, KC_BTN1, KC_BTN1, KC_BTN1,                   __MOUSE_R3_ARROW_KEYS__
),
};
