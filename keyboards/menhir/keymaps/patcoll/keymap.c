...
[_QWERTY] = LAYOUT_wrapper(
  ...
  KC_LSFT, _________________QWERTY_L3_________________, _________________QWERTY_R3_ARROWS__________,
  KC_LGUI, KC_LALT, SFT_SPC, SFT_SPC,                   RSE_ENT, KC_LCTL, KC_HYPR
),
...
[_MOUSE] = LAYOUT_wrapper(
  ...
  _______, KC_BTN1, KC_BTN1, KC_BTN1,                   KC_BTN1, KC_BTN2, _______
),
};
