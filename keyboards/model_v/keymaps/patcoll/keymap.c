...
[_QWERTY] = LAYOUT_wrapper(
  ...
  KC_LCTL, KC_HYPR, KC_LGUI, KC_LALT, SFT_SPC,                   RSE_ENT, CTL_ENT, __QWERTY_R3_ARROW_KEYS__
),
...
[_NAV] = LAYOUT_wrapper(
  ...
  _______, _______, _______, _______, _______,                   ALT_TAB,  _______, __NAV_R4_ARROW_KEYS___
),
