...
[_QWERTY] = LAYOUT_wrapper(
  ...
  KC_LSFT, KC_LSFT, _________________QWERTY_L3_________________, _________________QWERTY_R3_________________,
  KC_LCTL, KC_LGUI, KC_LALT, SFT_SPC, RSE_ENT,          KC_LCTL, __QWERTY_R4_NORMAL_KEYS_
),
...
[_GAMING] = LAYOUT_wrapper(
  ...
  _______, _______, _________________GAMING_L3_________________, _________________GAMING_R3_________________,
  _______, _______, _______, KC_SPC,  KC_ENT,           _______, _______, _______, _______
),
...
[_NAV] = LAYOUT_wrapper(
  ...
  KC_LSFT, KC_LSFT, __________________NAV_L3___________________, __________________NAV_R3___________________,
  _______, _______, _______, ALT_TAB, ALT_TAB,          ALT_TAB, __NAV_R4_ARROW_KEYS___
),
...
[_OSK] = LAYOUT_wrapper(
  ...
  _______, _______, __________________OSK_L3___________________, __________________OSK_R3___________________,
...
[_LOWER] = LAYOUT_wrapper(
  ...
  _______, _______, _________________LOWER_L3__________________, _________________LOWER_R3__________________,
...
[_RAISE] = LAYOUT_wrapper(
  ...
  _______, _______, _________________RAISE_L3__________________, _________________RAISE_R3__________________,
...
[_MEDIA] = LAYOUT_wrapper(
  ...
  _______, _______, _________________MEDIA_L3__________________, _________________MEDIA_R3__________________,
...
[_MOUSE] = LAYOUT_wrapper(
  ...
  _______, _______, _________________MOUSE_L3__________________, _________________MOUSE_R3__________________,
  _______, KC_BTN1, KC_BTN1, KC_BTN1, KC_BTN1,          KC_BTN2, KC_BTN2, _______, _______
),
};
