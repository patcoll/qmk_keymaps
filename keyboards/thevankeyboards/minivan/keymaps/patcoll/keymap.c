...
/*   QK_BOOT,   _______, _______, MO_RSE,     MO_RSE,                 MO_RSE,  _______, KC_MNXT, KC_VOLD, KC_MPLY */
/* ), */
/*  */
/* #<{(| LAYOUT_all( |)}># */
...
/* #<{(|   QK_BOOT,   _______, _______, _______,     _______,               _______, _______, KC_HOME, KC_PGDN, KC_END |)}># */
/* #<{(| ), |)}># */
/*  */
...
/* #<{(|   QK_BOOT,   _______, _______, _______,     _______,               _______, _______, KC_MNXT, KC_VOLD, KC_MPLY |)}># */
/* #<{(| ), |)}># */
/*  */
