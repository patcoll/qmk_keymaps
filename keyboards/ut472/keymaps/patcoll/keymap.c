...
[_QWERTY] = LAYOUT_wrapper(
  ...
  KC_LCTL, KC_HYPR, KC_LGUI, KC_LALT, SFT_SPC, SFT_SPC,            RSE_ENT, KC_LCTL, __QWERTY_R4_NORMAL_KEYS_
),
...
[_NAV] = LAYOUT_wrapper(
  ...
  _______, _______, _______, _______, _______, _______,            ALT_TAB,  _______, __NAV_R4_ARROW_KEYS___
),
