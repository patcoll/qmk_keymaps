...
[_QWERTY] = LAYOUT_wrapper(
  ...
  _______, KC_LSFT, _________________QWERTY_L3_________________, _________________QWERTY_R3_________________, KC_UP,
  _______, KC_LCTL, KC_LGUI, KC_LALT, _______, SFT_SPC,                   RSE_ENT, KC_LCTL, KC_HYPR, __QWERTY_R4_ARROW_KEYS__
),
...
[_NAV] = LAYOUT_wrapper(
  ...
  _______, KC_LSFT, __________________NAV_L3___________________, __________________NAV_R3___________________, _______,
  _______, _______, _______, _______, _______, ALT_TAB,                   ALT_TAB, _______, _______, __NAV_R4_ARROW_KEYS___
),
...
[_OSK] = LAYOUT_wrapper(
  ...
  _______, _______, __________________OSK_L3___________________, __________________OSK_R3___________________, _______,
...
[_LOWER] = LAYOUT_wrapper(
  ...
  _______, _______, _________________LOWER_L3__________________, _________________LOWER_R3__________________, _______,
...
[_RAISE] = LAYOUT_wrapper(
  ...
  _______, _______, _________________RAISE_L3__________________, _________________RAISE_R3__________________, _______,
...
[_MEDIA] = LAYOUT_wrapper(
  ...
  _______, _______, _________________MEDIA_L3__________________, _________________MEDIA_R3__________________, _______,
...
[_MOUSE] = LAYOUT_wrapper(
  ...
  _______, _______, _________________MOUSE_L3__________________, _________________MOUSE_R3__________________, _______,
