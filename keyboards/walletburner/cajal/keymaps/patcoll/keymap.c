...
[_QWERTY] = LAYOUT_wrapper(
  KC_TAB,  _________________QWERTY_L1_________________, _________________QWERTY_R1_________________, KC_BSPC, KC_BSPC, KC_MPLY,
  ...
  KC_LCTL, KC_LGUI, KC_LALT, SFT_SPC, RSE_ENT, KC_LCTL, KC_HYPR,                            KC_LEFT, KC_DOWN, KC_RGHT
),
...
[_NAV] = LAYOUT_wrapper(
  ...
  _______, _______, _______, ALT_TAB, ALT_TAB, _______, _______,                            KC_HOME, KC_PGDN, KC_END
),
